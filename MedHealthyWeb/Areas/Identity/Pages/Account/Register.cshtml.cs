    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == "Select Role" || Input.Role == null)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == null)
                    {
                        MedHealthy.Models.Patient patient = new();
                    ...
                    {
                        if (Input.Role == SD.Role_User_Patient) {
                            MedHealthy.Models.Patient patient = new();
                            _unitOfWork.Patient.Add(patient);
                            _unitOfWork.Save();
                            user.PatientId = patient.Id;
                        }
                        else if (Input.Role == SD.Role_User_Doctor)
                        {
                            MedHealthy.Models.Doctor doctor = new();
