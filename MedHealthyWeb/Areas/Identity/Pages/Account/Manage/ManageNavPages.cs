...
namespace  MedHealthyWeb.Areas.Identity.Pages.Account.Manage
{
    ...
    public static class ManageNavPages
    {
        ...
        public static string PersonalInfoDoctor => "PersonalInfoDoctor";
        ...
        public static string PersonalInfoDoctorNavClass(ViewContext viewContext) => PageNavClass(viewContext, PersonalInfoDoctor);
